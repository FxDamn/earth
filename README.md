...
```
npm create cloudflare@latest -- --template=cloudflare/templates/earth
```

A live public deployment of this template is available at [https://earth.templates.workers.dev](https://earth.templates.workers.dev)
